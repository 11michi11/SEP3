...
class LibraryOrders extends Component {
    ...
    handleConfirm = (e)=>{
        ...
        axios
          .delete( "https://localhost:5001/orders/"+e,
            { crossdomain: true,
              httpsAgent: agent,
              withCredentials: true }
          )
            ...
            return (
              <div key={o.orderId}>
                <div className="row">
                  ...
                  <div className="col-md-1"><a href="#" className="btn btn-success btn-sm mr-1 m-1" onClick={(e)=>{this.handleConfirm(o.orderId)}}>Return</a></div>
                </div>
              </div>  
            );
         })
