...
//
	...
	void addLibraryAdministrator(String libraryID, String name, String email, String password, String serverUrl) throws LibraryRepository.LibraryNotFoundException;

	void addBookStoreAdministrator(String bookstoreID, String name, String email, String password, String serverUrl) throws BookStoreRepository.BookStoreNotFoundException;
