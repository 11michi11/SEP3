...
public class Controller {
	...
	public static void main(String[] args) {
		...
		arguments.put("adminId", "a60bd45f-551e-4257-be31-06d171f86351");

		Request request = new Request(Request.Operation.DeleteLibraryAdministrator, arguments);
		try {
			controller.handleDeleteLibraryAdministrator(request);
