...
public class MakeOrder implements ApplicationContextAware {
	...
	public String borrowBook(@RequestBody String isbn, String libraryID, String customerID, String sessionKey) {
	...
	public String buyBook(@RequestBody String isbn, String bookstoreID, String customerID, String sessionKey) {
		SessionKeyManager.checkSessionKey(sessionKey);
		Controller controller = context.getBean(Controller.class);
